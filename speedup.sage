...
def _do_speedup():
    ...
    # Since this type gets created before we could ever hope to monkey patch the sage.categories.fields.Fields.ParentMethods
    ...
    # An alternative would be to replace the bytecode in `sage.categories.fields.Fields.ParentMethods.vector_space`
